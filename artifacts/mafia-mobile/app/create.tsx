    ...
    <View style={[styles.screen, { backgroundColor: colors.background, paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.bottom}>
          ...
          <PressableScale testID="create-submit" disabled={createRoom.isPending} onPress={submit} style={[styles.button, { backgroundColor: colors.primary }]}>
            {createRoom.isPending ? (
              <ActivityIndicator color={colors.primaryForeground} />
            ) : (
              <>
                <Text style={[styles.buttonText, { color: colors.primaryForeground }]}>Open the room</Text>
