...
import { GlowOrb, GlassPanel } from '@/components/cinematic';
  ...
  return (
    <View style={[styles.screen, { backgroundColor: colors.background, paddingTop: insets.top, paddingBottom: insets.bottom }]}>
      ...
      <Animated.View style={[styles.content, appearStyle]}>
        ...
        <PrimaryButton testID="continue-button" label="Enter the room" icon="arrow-right" onPress={continueToRoom} loading={saving} />
